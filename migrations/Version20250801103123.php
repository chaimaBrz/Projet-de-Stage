 ...
 */
final class Version20250801103123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_incident CHANGE equipement_id equipement_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_incident CHANGE equipement_id equipement_id INT NOT NULL');
    }
}
