 ...
 */
final class Version20250803174313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement_historique (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, ticket_incident_id INT NOT NULL, equipement_id INT NOT NULL, date DATETIME NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_1CC569A2C54C8C93 (type_id), INDEX IDX_1CC569A2357539C6 (ticket_incident_id), INDEX IDX_1CC569A2806F0F5C (equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE refresh_token (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ticket_incident (id INT AUTO_INCREMENT NOT NULL, user_createur_id INT NOT NULL, user_assigne_id INT DEFAULT NULL, equipement_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, INDEX IDX_B86A5D9BDAB9C870 (user_createur_id), INDEX IDX_B86A5D9B291C4C5C (user_assigne_id), INDEX IDX_B86A5D9B806F0F5C (equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE evenement_historique ADD CONSTRAINT FK_1CC569A2806F0F5C FOREIGN KEY (equipement_id) REFERENCES equipement (id)');
        ...
        $this->addSql('ALTER TABLE ticket_incident ADD CONSTRAINT FK_B86A5D9B806F0F5C FOREIGN KEY (equipement_id) REFERENCES equipement (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement_historique DROP FOREIGN KEY FK_1CC569A2806F0F5C');
